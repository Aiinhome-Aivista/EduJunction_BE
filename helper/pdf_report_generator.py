"""PDF Report Generator for EduJunction (SahajPath).
...
def generate_exam_report_pdf(
    ...
    header_data = [
        [
            Paragraph("<b>SahajPath</b> &bull; Student Diagnostic Report", title_style),
    ...
    footer_text = Paragraph(
        "<i>This report was automatically generated by SahajPath Diagnostic AI Engine (CBSE, ICSE & ISC).</i>",
        subtitle_style,
    )
